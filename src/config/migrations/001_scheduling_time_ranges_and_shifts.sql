...
-- Auto-sync trigger for backwards-compatibility with legacy code inserting only scheduled_time
...
-- Set NOT NULL after trigger guarantees value
ALTER TABLE sessions ALTER COLUMN scheduled_start_time SET DEFAULT '10:00:00';
ALTER TABLE sessions ALTER COLUMN scheduled_end_time SET DEFAULT '11:00:00';
